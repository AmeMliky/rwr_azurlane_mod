...
// --------------------------------------------
class AttackDefenseHandlerMap1_2 : PeacefulLastBase {
	// --------------------------------------------
	AttackDefenseHandlerMap1_2(GameModeInvasion@ metagame, int factionId) {
	...
	void applyDefaultMode(int enemyId) {
		if (enemyId == 2) {
            ...
            // at start of the map, they own 12 bases
			if (getBasesForFaction(enemyId) < 11) {
