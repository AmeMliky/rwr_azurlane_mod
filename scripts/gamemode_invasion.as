...
//		addTracker(Halloween(this));    // Halloween event only
	...
	protected void setupCallMarkers() {
		...
		array<CallMarkerConfig@> configs = {
			...
			CallMarkerConfig("qzyty_tank_0.call", "call_marker_drop", 12, 0.5),
			CallMarkerConfig("qzyty_tank_1.call", "call_marker_drop", 12, 0.5),
			CallMarkerConfig("qzyty_tank_2.call", "call_marker_drop", 12, 0.5),
